<html lang="en"><head>
    ...
    <title>No Dashboard Appointments</title>
...
<?php
  ...
  echo ' <div class="container center-align">
    <h1>No Appointments</h1>
      <p class="flow-text">Currently you have no confirmed appointments to display.</p>
  
   <a href="appointments.php" class="btn btn-large waves-effect waves-light green lighten-1"> Visit Appointments</a>
