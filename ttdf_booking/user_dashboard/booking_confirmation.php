...
function decrypt($data) {
    ...
    $user_id2 = $_SESSION['user_id'];
      ...
      // 1. CHANGE BOOKING STATUS FROM AVAILABLE TO UNAVAILABLE
    ...
    $stmtnew->bind_param('sis', $availability,$mananger_id2, $date);
...
// 3. ADDING APPOINTMENT INTO APPOINTMENTS TABLE
