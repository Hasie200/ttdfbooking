...
<h4>Register</h4>
  ...
  <form action="register.php" method="post"class="col s12 m6 offset-m3">
    ...
    <div class="row">
      ...
      <div class="input-field col s12">  <input id="first_name" name="first_name" type="text" class="validate">
        <label for="first_name">First Name</label>
      </div>
  

    <div class="input-field col s12">  <input id="last_name" name="last_name" type="text" class="validate">
        <label for="last_name">Last Name</label>
      </div>
   

    <div class="input-field col s12">  <input id="email" name="email" type="email" class="validate">
        ...
        <select class="browser-default black-text card-panel col s12" id="role" name="role">
    ...
    <div class="input-field col s12">  <input id="password" name="password" type="text" class="validate">
        <label for="password">Password</label>
      </div>
    


     <div class="input-field col s12 ">  <input id="confirm" name="confirm" type="text" class="validate">
    ...
    <button class="btn waves-effect waves-light col s12 " type="submit" name="action">Register
      ...
      <br>
    <a href = "http://miceducation.42web.io/ttdf_booking/" class="btn waves-effect waves-light col s8 m6 offset-m3 center-align " > Back To Home
