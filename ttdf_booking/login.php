...
<h4>Login</h4>
  ...
  <form action="login.php" method="post" class="col s12 m6 offset-m3">
    ...
    <div class="row">
      <div class="input-field col s12">  <input id="password" name="password" type="password" class="validate">
    ...
    <br>
    <a href = "http://miceducation.42web.io/ttdf_booking/" class="btn waves-effect waves-light col s12 " > Back To Home
